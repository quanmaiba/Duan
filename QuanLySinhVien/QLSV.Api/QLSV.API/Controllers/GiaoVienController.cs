...
namespace QLSV.API.Controllers
{
    ...
    public class GiaoVienController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("LuuGiaoVien")]
        public LuuGiaoVienRes LuuGiaoVien([FromBody] LuuGiaoVienReq request)
        {
            return giaoVienService.LuuGiaoVien(request);
        }

        [HttpGet]
        [Route("LayGiaoVien/{giaoVienId}")]
        public GiaoVienItem LayGiaoVien(int giaoVienId)
        {
            return giaoVienService.LayGiaoVien(giaoVienId);
        }

        [HttpDelete]
        [Route("XoaGiaoVien/{giaoVienId}")]
        public int XoaGiaoVien(int giaoVienId)
        {
            return giaoVienService.XoaGiaoVien(giaoVienId);
        }
    }
}